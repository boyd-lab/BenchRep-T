...
from .repertoire import Repertoire, augment_repertoire
from .util import basic_void_mark, human_amino_acids
...
class MotifFeatureExtractor(FeatureExtractor):
    ...
    def fit(self, repertoires: List[Repertoire], use_cache=True, save_cache=True):
        ...
        with get_context("fork").Pool(self.n_processes) as pool:
            ...
            assert len(self.idf.shape) == 1
            assert self.idf.shape[0] == result[0].shape[0]
            return result
