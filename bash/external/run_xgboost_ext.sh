  ...
  case "$dataset" in
    RA)
      args=(
        ...
        --repertoire_data_dir "${REPO_ROOT}/data/external_datasets/rheumatoid_arthritis/data_cleaned"
    ...
    Tb)
      args=(
        ...
        --repertoire_data_dir "${REPO_ROOT}/data/external_datasets/tuberculosis/data_cleaned"
